...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\Api\\RestauranteController' => 'getRestauranteControllerService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('yfniKkRioo', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.security_is_csrf_token_valid_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('eodZLaliuF', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('M6ThjBGgNf', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bbx10G-HP8', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XpnJ4gfBpG', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\Api\\RestauranteController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    protected static function getAssetMapperService($container)
    {
        ...
        }, 4), #[\Closure(name: 'asset_mapper', class: 'Symfony\\Component\\AssetMapper\\AssetMapper')] fn () => ($container->privates['asset_mapper'] ?? self::getAssetMapperService($container))), 'C:\\restaurante-render/assets/vendor'), ($container->targetDir.''.'/asset_mapper'), true), ($container->privates['asset_mapper.compiled_asset_mapper_config_reader'] ??= new \Symfony\Component\AssetMapper\CompiledAssetMapperConfigReader('C:\\restaurante-render/public/assets')));
    }
    ...
    {
        return $container->privates['asset_mapper.repository'] = new \Symfony\Component\AssetMapper\AssetMapperRepository(['C:\\restaurante-render\\vendor\\symfony\\ux-turbo\\src\\DependencyInjection/../../assets/dist' => '@symfony/ux-turbo', 'C:\\restaurante-render\\vendor\\symfony\\stimulus-bundle\\src\\DependencyInjection/../../assets/dist' => '@symfony/stimulus-bundle', 'assets/' => '', 'C:\\restaurante-render\\vendor\\nelmio\\api-doc-bundle/public' => 'bundles/nelmioapidoc'], 'C:\\restaurante-render', ['#^(?=[^\\.]).*\\.d\\.ts$#', '#^(?=[^\\.]).*.*/(?=[^\\.])controllers\\.json$#'], true, true);
    }
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('T1EqVqLt21', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('avZv4k+L4y', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('u9xHC5neCj', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Kl6AE6UcoF', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yXdPX8xR-d', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1pbGhd7neJ', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->privates['debug.file_link_formatter'] = new \Symfony\Component\ErrorHandler\ErrorRenderer\FileLinkFormatter($container->getEnv('default::SYMFONY_IDE'), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), 'C:\\restaurante-render', #[\Closure(name: 'debug.file_link_formatter.url_format', class: 'string')] fn () => ($container->privates['debug.file_link_formatter.url_format'] ?? $container->load('getDebug_FileLinkFormatter_UrlFormatService')));
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $a->addDriver(($container->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver(['C:\\restaurante-render\\src\\Entity'], true)), 'App\\Entity');
    ...
    {
        $container->privates['monolog.handler.main'] = $instance = new \Monolog\Handler\StreamHandler('C:\\restaurante-render/var/log/dev.log', 'debug', true, NULL, false);
    ...
    protected static function getTranslator_DefaultService($container)
    {
        ...
        ]), new \Symfony\Component\Translation\Formatter\MessageFormatter(new \Symfony\Component\Translation\IdentityTranslator()), 'en', ['translation.loader.php' => ['php'], 'translation.loader.yml' => ['yaml', 'yml'], 'translation.loader.xliff' => ['xlf', 'xliff'], 'translation.loader.po' => ['po'], 'translation.loader.mo' => ['mo'], 'translation.loader.qt' => ['ts'], 'translation.loader.csv' => ['csv'], 'translation.loader.res' => ['res'], 'translation.loader.dat' => ['dat'], 'translation.loader.ini' => ['ini'], 'translation.loader.json' => ['json']], ['cache_dir' => ($container->targetDir.''.'/translations'), 'debug' => true, 'resource_files' => ['af' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.af.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.af.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.af.xlf'], 'ar' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.ar.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.ar.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.ar.xlf'], 'az' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.az.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.az.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.az.xlf'], 'be' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.be.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.be.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.be.xlf'], 'bg' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.bg.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.bg.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.bg.xlf'], 'bs' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.bs.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.bs.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.bs.xlf'], 'ca' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.ca.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.ca.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.ca.xlf'], 'cs' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.cs.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.cs.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.cs.xlf'], 'cy' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.cy.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.cy.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.cy.xlf'], 'da' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.da.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.da.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.da.xlf'], 'de' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.de.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.de.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.de.xlf'], 'el' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.el.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.el.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.el.xlf'], 'en' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.en.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.en.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.en.xlf'], 'es' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.es.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.es.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.es.xlf'], 'et' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.et.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.et.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.et.xlf'], 'eu' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.eu.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.eu.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.eu.xlf'], 'fa' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.fa.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.fa.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.fa.xlf'], 'fi' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.fi.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.fi.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.fi.xlf'], 'fr' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.fr.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.fr.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.fr.xlf'], 'gl' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.gl.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.gl.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.gl.xlf'], 'he' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.he.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.he.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.he.xlf'], 'hr' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.hr.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.hr.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.hr.xlf'], 'hu' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.hu.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.hu.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.hu.xlf'], 'hy' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.hy.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.hy.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.hy.xlf'], 'id' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.id.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.id.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.id.xlf'], 'it' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.it.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.it.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.it.xlf'], 'ja' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.ja.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.ja.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.ja.xlf'], 'lb' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.lb.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.lb.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.lb.xlf'], 'lt' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.lt.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.lt.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.lt.xlf'], 'lv' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.lv.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.lv.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.lv.xlf'], 'mk' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.mk.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.mk.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.mk.xlf'], 'mn' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.mn.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.mn.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.mn.xlf'], 'my' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.my.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.my.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.my.xlf'], 'nb' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.nb.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.nb.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.nb.xlf'], 'nl' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.nl.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.nl.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.nl.xlf'], 'nn' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.nn.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.nn.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.nn.xlf'], 'no' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.no.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.no.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.no.xlf'], 'pl' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.pl.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.pl.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.pl.xlf'], 'pt' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.pt.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.pt.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.pt.xlf'], 'pt_BR' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.pt_BR.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.pt_BR.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.pt_BR.xlf'], 'ro' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.ro.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.ro.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.ro.xlf'], 'ru' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.ru.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.ru.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.ru.xlf'], 'sk' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.sk.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.sk.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.sk.xlf'], 'sl' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.sl.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.sl.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.sl.xlf'], 'sq' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.sq.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.sq.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.sq.xlf'], 'sr_Cyrl' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.sr_Cyrl.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.sr_Cyrl.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.sr_Cyrl.xlf'], 'sr_Latn' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.sr_Latn.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.sr_Latn.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.sr_Latn.xlf'], 'sv' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.sv.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.sv.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.sv.xlf'], 'th' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.th.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.th.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.th.xlf'], 'tl' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.tl.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.tl.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.tl.xlf'], 'tr' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.tr.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.tr.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.tr.xlf'], 'uk' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.uk.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.uk.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.uk.xlf'], 'ur' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.ur.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.ur.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.ur.xlf'], 'uz' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.uz.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.uz.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.uz.xlf'], 'vi' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.vi.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.vi.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.vi.xlf'], 'zh_CN' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.zh_CN.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.zh_CN.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.zh_CN.xlf'], 'zh_TW' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations\\validators.zh_TW.xlf', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations\\validators.zh_TW.xlf', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations\\security.zh_TW.xlf']], 'scanned_directories' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations', 'C:\\restaurante-render/translations', 'C:\\restaurante-render\\vendor\\symfony\\framework-bundle/translations', 'C:\\restaurante-render\\vendor\\doctrine\\doctrine-bundle/translations', 'C:\\restaurante-render\\vendor\\doctrine\\doctrine-migrations-bundle/translations', 'C:\\restaurante-render\\vendor\\symfony\\debug-bundle/translations', 'C:\\restaurante-render\\vendor\\symfony\\twig-bundle/translations', 'C:\\restaurante-render\\vendor\\symfony\\web-profiler-bundle/translations', 'C:\\restaurante-render\\vendor\\symfony\\stimulus-bundle/translations', 'C:\\restaurante-render\\vendor\\symfony\\ux-turbo/translations', 'C:\\restaurante-render\\vendor\\twig\\extra-bundle/translations', 'C:\\restaurante-render\\vendor\\symfony\\security-bundle/translations', 'C:\\restaurante-render\\vendor\\symfony\\monolog-bundle/translations', 'C:\\restaurante-render\\vendor\\symfony\\maker-bundle/translations', 'C:\\restaurante-render\\vendor\\nelmio\\api-doc-bundle/translations'], 'cache_vary' => ['scanned_directories' => ['C:\\restaurante-render\\vendor\\symfony\\validator/Resources/translations', 'C:\\restaurante-render\\vendor\\symfony\\form/Resources/translations', 'C:\\restaurante-render\\vendor\\symfony\\security-core/Resources/translations', 'translations', 'C:\\restaurante-render\\vendor\\symfony\\framework-bundle/translations', 'C:\\restaurante-render\\vendor\\doctrine\\doctrine-bundle/translations', 'C:\\restaurante-render\\vendor\\doctrine\\doctrine-migrations-bundle/translations', 'C:\\restaurante-render\\vendor\\symfony\\debug-bundle/translations', 'C:\\restaurante-render\\vendor\\symfony\\twig-bundle/translations', 'C:\\restaurante-render\\vendor\\symfony\\web-profiler-bundle/translations', 'C:\\restaurante-render\\vendor\\symfony\\stimulus-bundle/translations', 'C:\\restaurante-render\\vendor\\symfony\\ux-turbo/translations', 'C:\\restaurante-render\\vendor\\twig\\extra-bundle/translations', 'C:\\restaurante-render\\vendor\\symfony\\security-bundle/translations', 'C:\\restaurante-render\\vendor\\symfony\\monolog-bundle/translations', 'C:\\restaurante-render\\vendor\\symfony\\maker-bundle/translations', 'C:\\restaurante-render\\vendor\\nelmio\\api-doc-bundle/translations']]], []);
    ...
    {
        $a = new \Twig\Loader\FilesystemLoader([], 'C:\\restaurante-render');
        $a->addPath('C:\\restaurante-render\\vendor\\doctrine\\doctrine-bundle/templates', 'Doctrine');
        $a->addPath('C:\\restaurante-render\\vendor\\doctrine\\doctrine-bundle/templates', '!Doctrine');
        $a->addPath('C:\\restaurante-render\\vendor\\doctrine\\doctrine-migrations-bundle/templates', 'DoctrineMigrations');
        $a->addPath('C:\\restaurante-render\\vendor\\doctrine\\doctrine-migrations-bundle/templates', '!DoctrineMigrations');
        $a->addPath('C:\\restaurante-render\\vendor\\symfony\\debug-bundle/Resources/views', 'Debug');
        $a->addPath('C:\\restaurante-render\\vendor\\symfony\\debug-bundle/Resources/views', '!Debug');
        $a->addPath('C:\\restaurante-render\\vendor\\symfony\\web-profiler-bundle/Resources/views', 'WebProfiler');
        $a->addPath('C:\\restaurante-render\\vendor\\symfony\\web-profiler-bundle/Resources/views', '!WebProfiler');
        $a->addPath('C:\\restaurante-render\\vendor\\symfony\\ux-turbo/templates', 'Turbo');
        $a->addPath('C:\\restaurante-render\\vendor\\symfony\\ux-turbo/templates', '!Turbo');
        $a->addPath('C:\\restaurante-render\\vendor\\symfony\\security-bundle/Resources/views', 'Security');
        $a->addPath('C:\\restaurante-render\\vendor\\symfony\\security-bundle/Resources/views', '!Security');
        $a->addPath('C:\\restaurante-render\\vendor\\symfony\\maker-bundle/templates', 'Maker');
        $a->addPath('C:\\restaurante-render\\vendor\\symfony\\maker-bundle/templates', '!Maker');
        $a->addPath('C:\\restaurante-render\\vendor\\nelmio\\api-doc-bundle/templates', 'NelmioApiDoc');
        $a->addPath('C:\\restaurante-render\\vendor\\nelmio\\api-doc-bundle/templates', '!NelmioApiDoc');
        $a->addPath('C:\\restaurante-render\\vendor\\symfony\\twig-bridge/Resources/views/Email', 'email');
        $a->addPath('C:\\restaurante-render\\vendor\\symfony\\twig-bridge/Resources/views/Email', '!email');
        $a->addPath('C:\\restaurante-render\\vendor\\symfony\\twig-bridge/Resources/views/Form');
        ...
        $instance->addExtension(new \Symfony\Bundle\WebProfilerBundle\Profiler\CodeExtension($i, 'C:\\restaurante-render', 'UTF-8'));
    ...
    protected static function getValidator_BuilderService($container)
    {
        ...
        $instance->addXmlMappings(['C:\\restaurante-render\\vendor\\symfony\\form/Resources/config/validation.xml']);
    ...
    {
        return [
            'kernel.project_dir' => 'C:\\restaurante-render',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.logs_dir' => 'C:\\restaurante-render/var/log',
            'kernel.bundles' => [
            ...
            'kernel.bundles_metadata' => [
                'FrameworkBundle' => [
                    'path' => 'C:\\restaurante-render\\vendor\\symfony\\framework-bundle',
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ],
                'DoctrineBundle' => [
                    'path' => 'C:\\restaurante-render\\vendor\\doctrine\\doctrine-bundle',
                    'namespace' => 'Doctrine\\Bundle\\DoctrineBundle',
                ],
                'DoctrineMigrationsBundle' => [
                    'path' => 'C:\\restaurante-render\\vendor\\doctrine\\doctrine-migrations-bundle',
                    'namespace' => 'Doctrine\\Bundle\\MigrationsBundle',
                ],
                'DebugBundle' => [
                    'path' => 'C:\\restaurante-render\\vendor\\symfony\\debug-bundle',
                    'namespace' => 'Symfony\\Bundle\\DebugBundle',
                ],
                'TwigBundle' => [
                    'path' => 'C:\\restaurante-render\\vendor\\symfony\\twig-bundle',
                    'namespace' => 'Symfony\\Bundle\\TwigBundle',
                ],
                'WebProfilerBundle' => [
                    'path' => 'C:\\restaurante-render\\vendor\\symfony\\web-profiler-bundle',
                    'namespace' => 'Symfony\\Bundle\\WebProfilerBundle',
                ],
                'StimulusBundle' => [
                    'path' => 'C:\\restaurante-render\\vendor\\symfony\\stimulus-bundle',
                    'namespace' => 'Symfony\\UX\\StimulusBundle',
                ],
                'TurboBundle' => [
                    'path' => 'C:\\restaurante-render\\vendor\\symfony\\ux-turbo',
                    'namespace' => 'Symfony\\UX\\Turbo',
                ],
                'TwigExtraBundle' => [
                    'path' => 'C:\\restaurante-render\\vendor\\twig\\extra-bundle',
                    'namespace' => 'Twig\\Extra\\TwigExtraBundle',
                ],
                'SecurityBundle' => [
                    'path' => 'C:\\restaurante-render\\vendor\\symfony\\security-bundle',
                    'namespace' => 'Symfony\\Bundle\\SecurityBundle',
                ],
                'MonologBundle' => [
                    'path' => 'C:\\restaurante-render\\vendor\\symfony\\monolog-bundle',
                    'namespace' => 'Symfony\\Bundle\\MonologBundle',
                ],
                'MakerBundle' => [
                    'path' => 'C:\\restaurante-render\\vendor\\symfony\\maker-bundle',
                    'namespace' => 'Symfony\\Bundle\\MakerBundle',
                ],
                'NelmioApiDocBundle' => [
                    'path' => 'C:\\restaurante-render\\vendor\\nelmio\\api-doc-bundle',
            ...
            'translator.default_path' => 'C:\\restaurante-render/translations',
            ...
            'twig.default_path' => 'C:\\restaurante-render/templates',
